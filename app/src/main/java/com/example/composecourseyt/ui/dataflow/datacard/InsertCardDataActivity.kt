...
class InsertCardDataActivity : ComponentActivity() {
...
//        val amount = intent.getStringExtra("amount")
        ...
        setContent {
            Column(
                ...
                InsertCardData(phoneNumber, onBackClicked = { onBackPressed() })
            }
        }
    }
}
...
fun InsertCardData(
    ...
    Column(
        ...
        NextBtn(
            ...
            onClickNext = {
                val intent = Intent(context, EnterPinDataCardActivity::class.java)
