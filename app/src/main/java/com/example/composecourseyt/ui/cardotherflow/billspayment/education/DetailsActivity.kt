    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Column(
                ...
                DetailsPage( onBackClicked = { onBackPressed() })
            }
        }
    }
}
...
fun DetailsPage(
    ...
    Column(
        ...
        NextBtn(
            ...
            onClickNext = {
                val intent = Intent(context, EducationReceipt::class.java)
...
fun EnterDetails() {
    ...
    var selectedItem by remember {
        mutableStateOf(
            MatricNumberItem("Please select your option")
        )
    }

    val matricNumberItem = listOf(
        MatricNumberItem("School fee"),
        MatricNumberItem("Examination fee"),
        MatricNumberItem("Post Graduate fee")


        )
    val boxHeight = 141.dp // Adjust the desired height
        ...
        Column(
            ...
            DropdownMenu(
                ...
                Column(
                    ...
                    Column{
                        matricNumberItem.forEach { provider ->
                            DropdownMenuItem(
...
data class MatricNumberItem(val name: String)
