...
class EnterPinDataCardActivity: ComponentActivity() {
...
@Composable
fun EnterPinDataCardPage(phoneNumber: String?, onBackClicked: () -> Unit){
    ...
    Column(
        ...
        Column(modifier = Modifier.weight(1f)) {
            ...
            EnterBtn(
                ...
                onClickNext = {
                    val intent = Intent(context, DataCardReceipt::class.java)
